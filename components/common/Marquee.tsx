...
export default function ScrollVelocity({
  ...
  return (
    <div className="relative m-0 flex flex-nowrap overflow-hidden whitespace-nowrap leading-[0.8] tracking-[-2px]">
      <motion.div
        className="flex flex-row flex-nowrap whitespace-nowrap text-4xl font-semibold lowercase *:mr-6 *:block md:text-5xl xl:text-8xl bg-black dark:bg-white dark:text-black text-white font-labil py-8"
        style={{ x }}
      >
