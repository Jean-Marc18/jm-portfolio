...
export const dictionaries = {
  fr: {
    ...
    travauxPage: {
      ...
      heroH1b: "récents.",
      heroP:
        "Une sélection de projets en production, illustrant mon expertise sur les interfaces web et les solutions digitales — du secteur public à la fintech, en passant par l'agence et l'e-commerce.",
      m1: "Projets en production",
      m2: "Technologies maîtrisées",
      m3: "Expérience fintech",
      m4: "Marché financier régional",
      m3v: "2+ ans",
      ctaCase: "Voir le cas →",
    ...
    servicesPage: {
      ...
      heroH1f: "qui dure.",
      heroP:
        "Je travaille avec des équipes produit qui veulent construire vite, mais durablement — des startups fintech aux institutions publiques en passant par les agences.",
      ...
      faqs: [
        ...
        [
          ...
          "GMT+0 (Abidjan). Je travaille régulièrement avec des équipes en Europe occidentale (GMT à GMT+2), donc le décalage est minime.",
        ],
        [
    ...
    aboutPage: {
      ...
      p3a: "J'ai récemment travaillé chez ",
      p3inexa: "Inexa",
      p3b: " sur l'extranet de la ",
      p3cdc: "Caisse des Dépôts ivoirienne",
      p3c: " — une application de contrôle dépositaire qui gère les SGI, SGO et émetteurs sur le marché financier régional UMOA. Aujourd'hui, je suis disponible pour des missions freelance ou un poste salarié sur des projets agence, e-commerce ou institutionnels.",
      stats: [
        ["2+", "années en fintech"],
        ["03", "projets en production"],
        ["UMOA", "marché financier régional"],
        ["13+", "technologies maîtrisées"],
      ] as [string, string][],
      parLabel: "— Parcours",
      parH1: "Expérience professionnelle.",
      parP: "Une expérience significative et focalisée : la fintech B2B, le marché UMOA, et des applications réglementées à forte densité fonctionnelle.",
    ...
    contactPage: {
      ...
      formSub: "Ouvre votre client mail avec le message pré-rempli.",
      fName: "Nom complet",
      phName: "Aïcha Konaté",
      fEmail: "Email",
      ...
      coordLang: "Langues",
      coordLangV: "Français · Anglais (pro)",
      coordSt: "Statut",
    ...
    projectPage: {
      ...
      cases: {
        "pipv-pped": {
          ...
          ctxLabel: "— Contexte",
          ctxH1: "Une institution publique avait besoin d'un guichet numérique.",
          ctxTags: [
            "Authentification",
            "Rôles & permissions",
            "Upload sécurisé",
          ...
          mockP: "Captures à intégrer — placeholders pour l'instant. Chaque tuile représente un écran ou un parcours du produit en production.",
          mocks: [
            ["Dashboard administrateur", "Vue d'ensemble des dossiers, alertes, métriques."],
            ["Soumission de dossier", "Formulaire multi-étapes avec upload et validation Zod."],
            ["Gestion des rôles", "Attribution fine des permissions par module métier."],
          ] as [string, string][],
          skLabel: "— Stack technique",
          ...
          skGroups: [
            ...
            ["Auth & sécurité", ["NextAuth.js", "Middleware Next", "Server Actions"]],
          ...
          nextP: "Site vitrine animé pour une agence de communication, intégrant un CMS headless (Sanity) et des animations soignées en GSAP et Framer Motion. Performance, SEO et expérience visuelle au cœur du projet.",
  ...
  en: {
    ...
    travauxPage: {
      ...
      heroH1b: "work.",
      heroP:
        "A selection of production projects showing my expertise on web interfaces and digital solutions — from public sector to fintech, agency and e-commerce.",
      m1: "Projects in production",
      m2: "Technologies mastered",
      m3: "Fintech experience",
      m4: "Regional financial market",
      m3v: "2+ years",
    ...
    servicesPage: {
      ...
      heroH1f: "that lasts.",
      heroP:
        "I work with product teams who want to ship fast and sustainably — from fintech startups to public institutions, by way of agencies.",
      ...
      services: [
        {
          ...
          tags: ["Clean Architecture", "Hexagonal", "Monorepo", "Feature-component"],
          deliv: ["Audit of existing code", "Migration plan", "Monorepo setup", "Conventions documentation"],
        },
        {
          title: "UI / UX Interfaces",
          featured: true,
          ...
          tags: ["WCAG AA", "Design Systems", "Animation", "Radix UI"],
          deliv: ["Design tokens", "Component library", "A11y audit", "Micro-interactions"],
        },
        {
          title: "Performance & SEO",
          ...
          tags: ["Core Web Vitals", "SSR / SSG", "Open Graph", "Schema.org"],
          deliv: ["Lighthouse audit", "Image optimisation", "Sitemap & robots.txt", "Open Graph & Twitter Cards"],
        },
        {
          title: "Product integration",
          long: "I can read a dense business spec, dialogue with back-end and product teams, and ship an interface that holds in production. My ground: B2B fintech, regulated workflows, information-dense dashboards.",
          tags: ["Fintech", "UMOA", "B2B", "Complex workflows"],
          deliv: ["Story breakdown", "API integration", "Loading & error states", "Acceptance tests"],
        },
      ],
      delivHead: "Typical deliverables",
      procLabel: "— Process",
      procH1: "From brief to deployment, in four phases.",
      procP: "An iterative, transparent approach. At each stage you see what's moving, what's blocked, and what's coming. No black box.",
      procSteps: [
        ["Discovery", "Reading the brief, the business domain and the constraints. Framing workshop, risk identification, macro planning."],
        ["Architecture", "Stack choice, code organisation (monorepo, features), conventions, first technical skeleton in production."],
        ["Build & iterate", "Weekly preview deploys. Demo, feedback, adjustment. Integration tests and a11y audit along the way."],
        ["Launch", "Lighthouse audit, technical SEO, production monitoring, documentation and handover to the internal team."],
      ] as [string, string][],
      faqLabel: "— Frequently asked",
      faqH1: "The questions I get the most, answered upfront.",
      faqs: [
        ["Freelance or full-time?", "Both. I'm open to freelance missions (remote or in Abidjan) as well as a permanent role if the project and team align."],
        ["What timezone are you in?", "GMT+0 (Abidjan). I regularly work with teams in Western Europe (GMT to GMT+2), so the offset is minimal."],
        ["What's your go-to stack?", "Next.js + TypeScript + Tailwind, with Radix UI for accessible primitives, TanStack Query for data and Zustand for local state. All in a monorepo when the project warrants it."],
        ["Do you do back-end?", "My core is front-end. I'm comfortable with the BFF layer (Next.js API routes, NextAuth, headless CMS like Sanity), but I don't do infra or complex business back-end work."],
        ["What's your day rate?", "It varies with the mission, duration and engagement level. Best to talk — I send a tailored proposal within 48h."],
        ["How long to start?", "Immediately for short missions (< 1 month), within 2 weeks of signing for long missions."],
      ] as [string, string][],
    ...
    aboutPage: {
      ...
      p3a: "I recently worked at ",
      p3inexa: "Inexa",
      p3b: " on the extranet of the ",
      p3cdc: "Ivorian Deposits Fund",
      p3c: " — a custody control application managing SGIs, SGOs and issuers on the regional UMOA financial market. Today, I'm available for freelance missions or a permanent role on agency, e-commerce or institutional projects.",
      stats: [
        ["2+", "years in fintech"],
        ["03", "projects in production"],
        ["UMOA", "regional financial market"],
        ["13+", "technologies mastered"],
      ] as [string, string][],
      parLabel: "— Career",
      parH1: "Professional experience.",
      parP: "A focused, meaningful track record: B2B fintech, the UMOA market, and regulated, feature-dense applications.",
      ...
      skillsLocal: {
        "Frameworks & languages": ["Next.js", "React 19", "TypeScript", "JavaScript ES2024"],
        "Styling & UI": ["Tailwind CSS", "Radix UI", "CSS Modules", "shadcn/ui"],
        "State & data": ["TanStack Query", "Zustand", "React Hook Form", "Zod"],
        Animation: ["Framer Motion", "GSAP", "Lenis"],
      ...
      values: [
        ["01", "Readability over cleverness", "Code that other devs grasp in 5 minutes beats an elegant but opaque trick. Maintainability wins."],
        ["02", "Accessibility by default", "WCAG AA is a floor, not a ceiling. Contrast, keyboard nav, HTML semantics — prerequisites, not options."],
        ["03", "Business first", "Before the stack, the need. I spend time understanding the domain — fintech, e-commerce, institutional — before writing code."],
      ] as [string, string, string][],
    ...
    contactPage: {
      ...
      disclaimer: "Your info stays private. No marketing emails — I reply personally.",
      send: "Send the message",
      sideEmailHead: "Direct email",
      sideEmailP: "The fastest path. Be precise about context and timing — it helps me reply fast and well.",
    ...
    projectPage: {
      ...
      cases: {
        "pipv-pped": {
          ...
          ctxTags: ["Authentication", "Roles & permissions", "Secure upload", "Admin dashboard"],
          ctxP1: "The institution was managing its files and user follow-up through Excel and email. The need: a single, secure platform that centralises file submission, internal role management and admin steering.",
          ctxP2a: "The project started on a ",
          ctxP2b: "dense spec",
          ctxP2c: " (business workflows, permission levels, document traceability) and a tight schedule. The challenge: ship a stable production product quickly, while laying technical foundations the institution can extend with new modules in the coming months.",
          ctxP3a: "My mission focused on the ",
          ctxP3b: "front-end of the web application",
          ctxP3c: ": admin interface, user journeys, design system, integration of business APIs and third-party services (auth, upload, notifications).",
          appLabel: "— Approach",
          ...
          ch: [
            ["01", "Slice by feature, not by tech", "Rather than a layout by folder (components/, hooks/, lib/), each business feature (files, users, audit-log) is autonomous and owns its UI, logic and data schema."],
            ["02", "Server-side authentication", "NextAuth.js with server-side sessions, fine-grained role handling via Next.js middleware. No client-side bypass possible."],
            ["03", "Zod validation everywhere", "Zod schemas shared between client (React Hook Form) and server (Next.js API routes). One place to define a business rule."],
            ["04", "Upload straight to storage", "UploadThing to sign uploads on the server and send files straight from the browser — without transiting our infrastructure."],
          ] as [string, string, string][],
          mockLabel: "— Key screens",
          mockH1: "The product, through its interfaces.",
          mockP: "Captures to integrate — placeholders for now. Each tile represents a screen or a flow from the product in production.",
          mocks: [
            ["Admin dashboard", "Overview of files, alerts, metrics."],
            ["File submission", "Multi-step form with upload and Zod validation."],
            ["Role management", "Fine-grained permission allocation by business module."],
          ] as [string, string][],
          skLabel: "— Technical stack",
          ...
          skGroups: [
            ...
            ["UI & styling", ["Tailwind v3", "Radix UI", "CSS Modules"]],
            ["State & data", ["TanStack Query", "React Hook Form", "Zod"]],
            ["Auth & security", ["NextAuth.js", "Middleware Next", "Server Actions"]],
          ...
          nextP: "Animated marketing site for a communication agency, with a headless CMS (Sanity) and careful motion in GSAP and Framer Motion. Performance, SEO and visual experience at the core.",
